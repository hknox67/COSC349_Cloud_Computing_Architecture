...
export MYSQL_PWD='Admin@COSC349$e(U$$er'
...
echo "CREATE USER 'Adminwebuser'@'192.168.56.13' IDENTIFIED BY 'passwordtologin';" | mysql

# Grant all permissions to the database user "webuser" regarding
# the "fvision" database that we just created, above.
echo "GRANT ALL ON fvision.* TO 'Adminwebuser'@'192.168.56.13'" | mysql
...
# cat /vagrant/setup-database.sql | mysql -u root fvision
